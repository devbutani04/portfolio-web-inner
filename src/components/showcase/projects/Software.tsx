...
import website9 from './website9.jpg';
...
const SoftwareProjects: React.FC<SoftwareProjectsProps> = (props) => {
    ...
    return (
        <div className="site-page-content">
            ...
            <div className="text-block">
                <h2>umbrellalgbtq.com</h2>
                <br />
                <p>
                    Umbrella LGBTQ+ is a secure, inclusive social media platform designed specifically for the LGBTQ+ community. Leveraging blockchain technology and Web3 innovation, it offers a decentralized space where users can connect, support each other, and engage in advocacy. The platform features privacy-first social networking, a global marketplace for LGBTQ+-friendly products and services, and token-based rewards for content creators. Additional offerings include access to health and wellness resources, interest-based communities, and AI-driven personalized content feeds. Umbrella LGBTQ+ aims to revolutionize digital networking for LGBTQ+ individuals by providing a safe, empowering, and engaging environment.
                </p>
                <br />
                <div style={styles.width}>
                    <a href='https://umbrellalgbtq.com' target='_blank'>
                    <img src={website4} style={styles.image} alt="website3" />
                    </a>
                </div>
            </div>
            <div className="text-block">
                ...
                <div style={styles.width}>
                    ...
                    <img src={website5} style={styles.image} alt="website3" />
                    </a>
                </div>
            </div>
            <div className="text-block">
                ...
                <div style={styles.width}>
                    ...
                    <img src={website9} style={styles.image} alt="website9" />
                    </a>
                </div>
            </div>
            <div className="text-block">
                ...
                <div style={styles.width}>
                    ...
                    <img src={website8} style={styles.image} alt="website3" />
                    </a>
                </div>
            </div>
            <div className="text-block">
                ...
                <div style={styles.width}>
                    ...
                    <img src={website7} style={styles.image} alt="website3" />
                    </a>
                </div>
            </div>
